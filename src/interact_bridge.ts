...
import { Mina, PrivateKey, AccountUpdate, fetchAccount, PublicKey, UInt64, Account } from 'o1js';
...
try {
    ...
    let tx = await Mina.transaction(
        ...
        async () => {
            ...
            await fetchAccount({publicKey: PublicKey.fromBase58("B62qijRin68JqQwr42E6PQSDncYzH1FwVv12SiZDKNs4xnmTTGNu4pL")});
            // zkApp.lock(
            //     // PublicKey.fromBase58("xvQ3YeEJzMJP8MhusyFL3hruWPfMqXzjwQiCXYyurf9cZgC4FB"),
            //     feepayerAddress,
            //     // UInt64.one
            // )
        }
