...
try {
  ...
  let tx = await Mina.transaction(
    { sender: feepayerAddress, fee, nonce: +nonce.toString() },
    async () => {
  ...
  let tx2 = await Mina.transaction(
    { sender: feepayerAddress, fee, nonce: +nonce.add(1).toString()  },
    async () => {
      // await AccountUpdate.fundNewAccount(feepayerAddress, 1);
      console.log("================================2");
      await bridgeContract.unlock(
  ...
  let tx4 = await Mina.transaction(
    { sender: feepayerAddress, fee, nonce: +nonce.add(3).toString()  },
    async () => {
      // await AccountUpdate.fundNewAccount(feepayerAddress, 1);
      console.log("================================4");
      await bridgeContract.unlock(
  ...
  let tx5 = await Mina.transaction(
    { sender: feepayerAddress, fee, nonce: +nonce.add(4).toString()  },
    async () => {
      // await AccountUpdate.fundNewAccount(feepayerAddress, 1);
      console.log("================================5");
      await bridgeContract.unlock(
